...
func (x *SpaceQueryRequest) Reset() {
	*x = SpaceQueryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SpaceQueryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SpaceQueryRequest) ProtoMessage() {}

func (x *SpaceQueryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_license_space_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SpaceQueryRequest.ProtoReflect.Descriptor instead.
func (*SpaceQueryRequest) Descriptor() ([]byte, []int) {
	return file_proto_license_space_proto_rawDescGZIP(), []int{1}
}

func (x *SpaceQueryRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *SpaceQueryResponse) Reset() {
	*x = SpaceQueryResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SpaceQueryResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SpaceQueryResponse) ProtoMessage() {}

func (x *SpaceQueryResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_license_space_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SpaceQueryResponse.ProtoReflect.Descriptor instead.
func (*SpaceQueryResponse) Descriptor() ([]byte, []int) {
	return file_proto_license_space_proto_rawDescGZIP(), []int{2}
}

func (x *SpaceQueryResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *SpaceQueryResponse) GetSpace() *SpaceEntity {
	if x != nil {
		return x.Space
	}
	return nil
...
var file_proto_license_space_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x27, 0x0a, 0x11, 0x53, 0x70,
	0x61, 0x63, 0x65, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e,
	0x61, 0x6d, 0x65, 0x22, 0x69, 0x0a, 0x12, 0x53, 0x70, 0x61, 0x63, 0x65, 0x51, 0x75, 0x65, 0x72,
	...
	0x75, 0x73, 0x12, 0x2a, 0x0a, 0x05, 0x73, 0x70, 0x61, 0x63, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x14, 0x2e, 0x6c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x2e, 0x53, 0x70, 0x61, 0x63,
	0x65, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x52, 0x05, 0x73, 0x70, 0x61, 0x63, 0x65, 0x22, 0x40,
	0x0a, 0x10, 0x53, 0x70, 0x61, 0x63, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x22, 0x7e, 0x0a, 0x11, 0x53, 0x70, 0x61, 0x63, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x27, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x6c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x2e,
	...
	,
...
var file_proto_license_space_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_license_space_proto_goTypes = []interface{}{
	(*SpaceCreateRequest)(nil), // 0: license.SpaceCreateRequest
	(*SpaceQueryRequest)(nil),  // 1: license.SpaceQueryRequest
	(*SpaceQueryResponse)(nil), // 2: license.SpaceQueryResponse
	...
	(*SpaceEntity)(nil),        // 6: license.SpaceEntity
	(*BlankResponse)(nil),      // 7: license.BlankResponse
}
var file_proto_license_space_proto_depIdxs = []int32{
	5, // 0: license.SpaceQueryResponse.status:type_name -> license.Status
	6, // 1: license.SpaceQueryResponse.space:type_name -> license.SpaceEntity
	5, // 2: license.SpaceListResponse.status:type_name -> license.Status
	6, // 3: license.SpaceListResponse.space:type_name -> license.SpaceEntity
	0, // 4: license.Space.Create:input_type -> license.SpaceCreateRequest
	1, // 5: license.Space.Query:input_type -> license.SpaceQueryRequest
	3, // 6: license.Space.List:input_type -> license.SpaceListRequest
	7, // 7: license.Space.Create:output_type -> license.BlankResponse
	2, // 8: license.Space.Query:output_type -> license.SpaceQueryResponse
	4, // 9: license.Space.List:output_type -> license.SpaceListResponse
...
func file_proto_license_space_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_license_space_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SpaceQueryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_license_space_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SpaceQueryResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
